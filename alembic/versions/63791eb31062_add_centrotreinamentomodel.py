...
Revision ID: 63791eb31062
Revises: 45e654438e35
Create Date: 2025-01-22 16:19:40.641224
...
revision: str = '63791eb31062'
down_revision: Union[str, None] = '45e654438e35'
...
def upgrade() -> None:
    ...
    sa.Column('pk_id', sa.Integer(), nullable=False),
    sa.Column('nome', sa.String(length=50), nullable=False),
    sa.Column('endereço', sa.String(length=60), nullable=False),
